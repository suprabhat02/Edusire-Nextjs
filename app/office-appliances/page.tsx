...
import { Briefcase, Truck, Award, Shield, Download, ShoppingCart, Phone } from "lucide-react"
...
const productCategories = [
  {
    ...
    products: ["Business Laptops", "Gaming Laptops", "Desktop PCs", "Monitors", "Keyboards & Mouse"],
  },
  {
    title: "Printers & Scanners",
    description: "High-quality printing and scanning solutions",
    image: "/placeholder.svg?height=200&width=300",
    products: ["Laser Printers", "Inkjet Printers", "Multifunction Printers", "Scanners", "Printer Supplies"],
  },
  {
    title: "Office Furniture",
    description: "Ergonomic and stylish office furniture",
    image: "/placeholder.svg?height=200&width=300",
    products: ["Office Chairs", "Office Desks", "Filing Cabinets", "Conference Tables", "Storage Solutions"],
  },
  {
    title: "Stationery & Supplies",
    description: "Complete range of office stationery",
    image: "/placeholder.svg?height=200&width=300",
    products: ["Paper & Notebooks", "Pens & Pencils", "Files & Folders", "Binding Supplies", "Office Accessories"],
  },
  {
    title: "Networking Equipment",
    description: "Routers, switches, and networking solutions",
    image: "/placeholder.svg?height=200&width=300",
    products: ["WiFi Routers", "Network Switches", "Cables", "Access Points", "Security Cameras"],
  },
  {
    title: "Audio Visual",
    description: "Projectors, speakers, and AV equipment",
    image: "/placeholder.svg?height=200&width=300",
    products: ["Projectors", "Speakers", "Microphones", "Video Conferencing", "Interactive Boards"],
  },
]
...
const testimonials = [
  ...
  },
  {
    ...
    content: "Reliable supplier for our computer lab equipment. Great after-sales support and competitive pricing.",
    rating: 5,
  },
  {
...
export default function OfficeAppliancesPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-20 pb-16 bg-gradient-to-r from-green-600 to-green-800 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold mb-6">Office Appliances Division</h1>
            <p className="text-xl mb-8 opacity-90">
              Your trusted partner for complete office solutions - from laptops to furniture
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Your reliable partner for all office equipment needs</p>
          </div>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Comprehensive range of office equipment and supplies</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Fill out the form below for customized pricing and solutions</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="printers">Printers & Scanners</SelectItem>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="bg-primary text-primary-foreground rounded-2xl p-12 text-center">
            <h2 className="text-4xl font-bold mb-6">Download Our Complete Catalog</h2>
            <p className="text-xl mb-8 opacity-90">
              Get detailed information about all our products, specifications, and pricing
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary">
