...
import { ChevronLeft, ChevronRight, BookOpen, Briefcase, Leaf, Star, Users, Award, Phone, Mail } from "lucide-react"
...
const highlights = [
  {
    ...
    description: "Comprehensive coaching for Classes 9-12, JEE, NEET & Foundation courses",
    stats: "500+ Students Enrolled",
  },
  {
    icon: Briefcase,
    title: "Office Solutions",
    description: "Complete range of office appliances, furniture, and stationery supplies",
    stats: "ISO Certified Supplier",
  },
  {
    icon: Leaf,
    title: "Ayurvedic Wellness",
    description: "Authentic ayurvedic medicines and health products with trademark guarantee",
...
const testimonials = [
  ...
  },
  {
    name: "Rajesh Kumar",
    role: "Business Owner",
    content: "Best office equipment supplier in the region. Quality products with excellent after-sales service.",
    rating: 5,
  },
  {
    name: "Dr. Meera Singh",
    role: "Ayurveda Practitioner",
    content: "Their ayurvedic products are authentic and effective. I recommend them to all my patients.",
    rating: 5,
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Your trusted partner for education, office solutions, and wellness products
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                A dynamic and visionary entrepreneur, educator, and social contributor, widely recognized for his
                commitment to empowering students and uplifting communities through education and service.
              </p>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of satisfied students and businesses who trust EDUSIRES
          </p>
