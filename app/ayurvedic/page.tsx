...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "Using their immunity booster for 6 months. Haven't fallen sick even once. Highly effective products.",
    rating: 5,
  },
  {
    name: "Priya Devi",
    ...
    content:
      "Their hair oil transformed my hair health completely. Natural products with amazing results.",
    rating: 5,
  },
];
        ...
        <div className="container mx-auto px-6 md:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Authentic Ayurvedic solutions with trademarked guarantee for
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                About Our Ayurvedic Line
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                EDUSIRES brings you authentic Ayurvedic products rooted in
                ancient wisdom and backed by modern science. Our products are
                carefully formulated using traditional recipes and high-quality
                natural ingredients.
              </p>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Share your health concerns and get customized product
                  recommendations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="immunity">
                          Immunity & General Health
                        </SelectItem>
                        <SelectItem value="digestive">
                          Digestive Issues
                        </SelectItem>
                        <SelectItem value="skin-hair">
                          Skin & Hair Problems
                        </SelectItem>
